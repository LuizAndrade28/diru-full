class Transaction < ApplicationRecord
  ...
  enum :bank_name, { nubank: 0, itau: 1, bradesco: 2, santander: 3, caixa: 4, banco_do_brasil: 5, inter: 6, original: 7, picpay: 8, mercado_pago: 9, pagseguro: 10, banrisul: 11, sicredi: 12, bmg: 13, next: 14, agibank: 15, bs2: 16 }
  enum :category, {
  ...
  def set_installments
    return unless self.installments_qty.present? && self.installments_qty > 1
